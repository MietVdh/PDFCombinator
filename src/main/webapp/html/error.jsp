...
<title>PDFCombinator | Error</title>
<link rel="stylesheet"
...
<body>
	...
	<nav class="navbar py-5 px-6" role="navigation"
		...
		<div class="navbar-menu mx-6">
			<div class="navbar-start">
				<a class="navbar-item" href="/PDFCombinator/home"><i
					class="fa-sharp fa-solid fa-house"></i>Home</a> <a class="navbar-item"
					href="/PDFCombinator/about"><i class="fa-solid fa-circle-info"></i>About</a>
			</div>
	...
	<main class="container pb-6">
		...
		<section class="content py-1">
			...
			<h1 class="title is-1" >Sorry, an error occured.</h1>
		
		</section>

	<section class="content">
		<p class="para">Please go to <a class="link" href="/PDFCombinator/index">Home Page</a></p>
